package com.dea.NestSwap.security.config;

import com.dea.NestSwap.repository.UserRepository;
import com.dea.NestSwap.service.security_service.RsaKeyProperties;
...
public class SecurityConfiguration {
    ...
    public UserDetailsService userDetailsService(UserRepository userRepository) {
        return username -> userRepository.findByUsername(username).orElseThrow(() -> new UsernameNotFoundException("User not foundaa."));
    }
